...
from .models import (
    Province, District, Ward, Location, Station, TideMeasurement, User, Policy, Article, Category, MiniAppOption
)
...
class MiniAppOptionSerializer(serializers.ModelSerializer):
    class Meta:
        model = MiniAppOption
        fields = '__all__'