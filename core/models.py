...
class User(models.Model):
    ...
    idByOA = models.CharField(max_length=255)  # đổi tên từ access_token thành idByOA
...
class Article(models.Model):
    ...
    postAt = models.DateTimeField(default=timezone.now)
...
class MiniAppOption(models.Model):
